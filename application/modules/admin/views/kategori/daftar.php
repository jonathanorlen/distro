...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <div class="row mt">
                          ...
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <th><i class="fa fa-bookmark"></i> Keterangan</th>
                             ...
                             <?php
                                            ...
                                            $ambil_data = $this->db->get('kategori');
            ...
            <a href="<?php echo base_url() . 'kategori/detail?id_kategori='.$item['id'] ?>"><button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button></a>
              
            <a href="<?php echo base_url() . 'kategori/ubah?id_kategori='.$item['id'] ?>" ><button class="btn btn-primary btn-xs"  ><i class="fa fa-pencil"></i></button></a>
              
            <a href="<?php echo base_url() . 'kategori/hapus?id_kategori='.$item['id'] ?>"><button class="btn btn-danger btn-xs"  onclick="return confirm('Are you sure?')" ><i class="fa fa-trash-o "N></i></button></a>
              ...
              <br>
              <div> <button class="btn btn.flat " ><i class="fa plus-square"></i><a href="<?php echo base_url() . 'kategori/tambah' ?>">tambah</a></button></div>
        </section>
      </section>
