          ...
          <section class="wrapper">
              ...
              <div class="col-lg-12">
                <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i>Detail Data Kategori</h4>
                        <?php
                        ...
                        ?>
                          <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'kategori/simpan_tambah' ?>">
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" readonly id="inputSuccess" name="kategori" value="<?php echo $hasil_ambil_data->kategori;?>">
                                  </div>
                              </div>
