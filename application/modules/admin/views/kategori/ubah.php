              ...
              <div class="col-lg-12">
                <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input Messages</h4>
                          <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'kategori/simpan_ubah' ?>">
                          	<?php

									$parameter = $_GET['id_kategori'];
								    $ambil_data = $this->db->query(" SELECT * FROM kategori where id= '$parameter' ");
								    $hasil_ambil_data = $ambil_data->row();

							?>
                              <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">Kategori Distro</label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="inputSuccess" name="kategori" value="<?php echo $hasil_ambil_data->kategori;?>">
                                  </div>
                              </div>
