...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i>TABEL PRODUK</h4>
                            <hr>
                              <thead>
                              <tr>
                             ...
                             <?php
                              ...
                              ?> 
                                        ...
                                        <td>
                                         ...
                                         <a href="<?php echo base_url() . 'produk/detail?id_produk='.$item['id'] ?>"> <button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button></a>
                                            
                                           <a href="<?php echo base_url() . 'produk/ubah?id_produk='.$item['id'] ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                            
                                           <a href="<?php echo base_url() . 'produk/hapus?id_produk='.$item['id'] ?>"><button class="btn btn-danger btn-xs" onclick="return confirm('apakah anda yakin hapus')"><i class="fa fa-trash-o "></i></button></a>
              ...
              <br>
      <center>
              <div> <button class="btn btn-success btn-xs"><i class="fa fa-plus" ><a href="<?php echo base_url() . 'produk/tambah' ?>">tambah</a></i></button></div>
      </center>
        </section>
      </section>
