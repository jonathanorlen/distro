              ...
              <div class="col-lg-12">
                <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input Messages</h4>
                          <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'promo/simpan_ubah' ?>">
                          	<?php

									$parameter = $_GET['id_promo'];
								    $ambil_data = $this->db->query(" SELECT * FROM promo where id= '$parameter' ");
								    $hasil_ambil_data = $ambil_data->row();

							?>
							 <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">ID promo Distro</label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="inputSuccess" name="id_promo" value="<?php echo $hasil_ambil_data->id;?>">
                              </div>
                              </div>
                              <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">Promo Distro</label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="inputSuccess" name="promo" value="<?php echo $hasil_ambil_data->promo;?>">
                                  </div>
                              </div>
                              <div class="form-group has-warning">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputWarning">Potongan </label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="inputWarning" name="potongan"  value="<?php echo $hasil_ambil_data->potongan;?>">
                                  </div>
                              </div>
                              <div class="form-group has-error">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputError">Status</label>
                                  <div class="col-lg-10">
                                      <input type="textarea" class="form-control" id="inputError" name="status"  value="<?php echo $hasil_ambil_data->status;?>">
                                  </div>
                              </div>
                              <div>
