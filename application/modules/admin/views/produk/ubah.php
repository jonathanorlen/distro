              ...
              <div class="col-lg-12">
                <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> ubah data produk</h4>
                          <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'produk/simpan_ubah' ?>">
                          	<?php
							...
							?>
							 <div class="form-group has-success">
                              ...
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="inputWarning" name="keterangan" value="<?php echo $hasil_ambil_data->keterangan;?>">
                                  </div>
                              </div>
                              <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputError">harga</label>
                                  <div class="col-lg-10">
                                      <input type="textarea" class="form-control" id="inputError" name="harga" value="<?php echo $hasil_ambil_data->harga;?>">
                                  </div>
                              </div>
                              ...
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="textarea" class="form-control" id="inputError" name="promo" value="<?php echo $hasil_ambil_data->promo;?>">
                                  </div>
                              </div>
                              <div class="form-group has-success">
                              ...
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="textarea" class="form-control" id="inputError" name="kategori" value="<?php echo $hasil_ambil_data->kategori;?>">
                                  </div>
                              </div>
                              <div>
