                ...
                <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input produk</h4>
                              ...
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                      <input type="textarea" class="form-control" id="inputError" name="harga">
                                  </div>
                              </div>
                              ...
                              <div class="form-group has-success">
                                  ...
                                  <div class="col-lg-10">
                                     <select name="promo" class="form-control">
                                        ...
                                        <?php
                                        $get_promo = $this->db->get('promo');
                                        $hasil_promo = $get_promo->result();

                                        foreach ($hasil_promo as $item) {
                                          echo '<option value="'.$item->promo.'">'.$item->promo.'</option>';
                                        }
                                        ?>
                                      </select>
                                  </div>
