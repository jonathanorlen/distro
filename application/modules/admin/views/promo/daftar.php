...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i>Tabel Promo</h4>
                            <hr>
                              <thead>
                              <tr>
                                  <th>Id</th>
            ...
            <a href="<?php echo base_url() . 'promo/detail?id_promo='.$item['id'] ?>"><button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button></a>
              
            <a href="<?php echo base_url() . 'promo/ubah?id_promo='.$item['id'] ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
              
            <a href="<?php echo base_url() . 'promo/hapus?id_promo='.$item['id'] ?>"><button onclick="return confirm('Are you sure?')"  class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                  </td>n
      </td>
    </tr>
              ...
              <br>
      <center>
              <div> <button><a href="<?php echo base_url() . 'promo/tambah' ?>">Tambah</a></button></div>
      </center>
        </section>
      </section>
