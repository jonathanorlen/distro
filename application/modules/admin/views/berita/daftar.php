...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i>TABEL berita</h4>
                            <hr>
                              <thead>
                              <tr>
            ...
            <button class="btn btn-success btn-xs"><i class="fa fa-check"><a href="<?php echo base_url() . 'berita/detail?id_berita='.$item['id'] ?>">detail</a></i></button>
              
            <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"> <a href="<?php echo base_url() . 'berita/ubah?id_berita='.$item['id'] ?>">ubah</a></i></button>
              
            <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "> <a href="<?php echo base_url() . 'berita/hapus?id_berita='.$item['id'] ?><script>
function myFunction() {
    confirm("Press a button!");
              ...
              <br>
      <center>
              <div> <button><a href="<?php echo base_url() . 'berita/tambah' ?>">tambah</a></button></div>
      </center>
        </section>
      </section>
