              ...
              <div class="col-lg-12">
                <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Input Messages</h4>
                          <form class="form-horizontal tasi-form" method="POST" action="<?php echo base_url() . 'berita/simpan_ubah' ?>">
                          	<?php

									$parameter = $_GET['id_berita'];
								    $ambil_data = $this->db->query(" SELECT * FROM berita where id= '$parameter' ");
								    $hasil_ambil_data = $ambil_data->row();

							?>
							                              <div class="form-group has-success">
                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">berita Distro</label>
                                  <div class="col-lg-10">
                                      <input type="text" class="form-control" id="inputSuccess" name="judul" value="<?php echo $hasil_ambil_data->judul;?>">
                                  </div>
                              </div>
